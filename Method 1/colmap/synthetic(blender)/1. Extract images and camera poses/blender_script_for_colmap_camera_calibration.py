# Extracts camera calibration parameters for a given
# camera and writes them to cameras.txt in colmap format
...
save_path = "C:/Users/masri/OneDrive/Documents/blender/sim11/"
fileName="cameras"
target_camera = 'Camera.001'
...
if __name__ == "__main__":
    ...
    cam = bpy.data.objects[target_camera]
    P, K, RT = get_3x4_P_matrix_from_blender(cam)
    print("K")
    print(K)
    
    #   CAMERA_ID, MODEL, WIDTH, HEIGHT, PARAMS[]
    cameras_calibration = ' '.join([
    "#   CAMERA_ID, MODEL, WIDTH, HEIGHT, PARAMS[]"
    "\n1", "PINHOLE", 
    ...
    str(K[0][0]), str(K[1][1]),
    str(K[0][2]), str(K[1][2])])
    cameras_calibration = ''.join([cameras_calibration, '\n'])
#    print(cameras_calibration)
    ...
    with open(file, "w") as f:
        f.write(str(cameras_calibration))
    f.close()
